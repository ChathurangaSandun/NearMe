...
class PlanetSummary extends StatelessWidget {
  ...
  PlanetSummary( {this.horizontal = true});
      ...
      return new Container(
        child: new Row(
          ...
          children: <Widget>[
            ...
            new Text("35.69""", style: Style.smallTextStyle),
          ]
        ),
      );
    }
    ...
    final planetCardContent = new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          ...
          new Text("dfad", style: Style.titleTextStyle),
          new Container(height: 10.0),
          new Text("12.58", style: Style.commonTextStyle),
          new Separator(),
          new Row(
